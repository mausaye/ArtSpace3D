    ...
    return (
        <div class="parent">
            ...
            <div class="body">
                ...
                In order to access the available shapes, first click the side-menu icon. Then, click on the desired shape type ("3D Shapes" or "2D Shapes"). 
                Clicking on the desired shape type will cause a dropdown menu of usable shapes to appear.
                <br></br>
                <h3>Adding a Shape:</h3><p style={{paddingLeft: '4vw'}}>In order to add a shape, click on the name of the desired shape. This will cause the shape to appear in the center of the screen.</p>
                ...
                You can also press the "T" key on the keyboard to cause an xyz-axis to appear on the shape. Pressing and dragging the arrows on each axis will allow the user to move the shape's location on the current axis.</p>
